                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="email" class="form-control" :class="{ 'is-invalid': errors.get('name') }" v-model="name" required
                                           autofocus autocomplete="off">
                                    <span v-text="errors.get('name')" class="invalid-feedback d-block"></span> <!-- Handling validation messages -->
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control" :class="{ 'is-invalid': errors.get('email') }" v-model="email" required
                                           autofocus autocomplete="off">
                                    <span v-text="errors.get('email')" class="invalid-feedback d-block"></span>
                                </div>
                            </div>
